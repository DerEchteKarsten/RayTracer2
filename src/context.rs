...
pub struct Context {
    ...
    pub ray_tracing: RayTracingContext,
...
impl ShaderBindingTable {
    pub fn new(ctx: &mut Context, pipeline: &RayTracingPipeline) -> Result<Self> {
...
impl Context {
    fn create_frame(&mut self, size: PhysicalSize<u32>) -> Result<Frame> {
